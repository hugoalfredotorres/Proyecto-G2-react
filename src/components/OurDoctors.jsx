  ...
  return (
    <div className="py-16 bg-[#EBEBFE] ">
      <h1 className="text-3xl md:text-5xl font-semibold text-gray-700 text-center capitalize">
        Nuestros <span className="text-secondary">Especialistas</span> Doctores
      </h1>
      <p className="text-center text-gray-600 mt-4 max-w-2xl mx-auto px-4">
        {" "}
        Nuestro equipo de especialistas altamente calificados se dedica a brindar atención experta adaptada a sus necesidades de salud específicas.
      </p>
