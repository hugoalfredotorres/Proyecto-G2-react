    ...
    <footer className="py-16 w-full bg-[#231F53] text-white">
      <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col items-center">
        ...
        <p className="text-gray-400 text-center max-w-xl text-sm font-normal leading-relaxed">
          {" "}
          Tu salud, nuestra prioridad: médicos de confianza y atención moderna para un futuro más saludable.
        </p>
        <div className="flex flex-col items-center justify-center text-center space-y-2">
          <p className="md:text-lg text-gray-400 pb-8">
            {" "}
            Suscríbete para recibir las últimas actualizaciones de salud, consejos de bienestar y servicios exclusivos para pacientes.
          </p>
      ...
      <div className="border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-6 text-center">
          <p>Hospital de Pediatria Garrahan ©2025. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
